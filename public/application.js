...
/***/ function(module, exports, __webpack_require__) {
	...
	var playerArray = (_playerArray = {}, _defineProperty(_playerArray, player1, []), _defineProperty(_playerArray, player2, []), _playerArray);
	// Game cells ID ******
	...
	var getGameOver = function getGameOver(data) {
	  gameapi.getGameOver(data).then(gameui.getGameSuccess).catch(gameui.getGameFailure);
	};
	// ***************************************************
	...
	var checkForWin = function checkForWin(player, playerTiles) {
	  ...
	  var _loop = function _loop(i) {
	    ...
	    var winCombo = [];
	    playerTiles.forEach(function (index) {
	...
	var declareAndLogWinner = function declareAndLogWinner(player, combo) {
	...
	var startNewGame = function startNewGame() {
	  ...
	  usedTiles = [];
	  playerArray = (_playerArray2 = {}, _defineProperty(_playerArray2, player1, []), _defineProperty(_playerArray2, player2, []), _playerArray2);
	  gameOver = false;
	  $('.square').text('');
	...
	var resetGame = function resetGame() {
	  ...
	  currentPlayer = player1;
	  usedTiles = [];
	  playerArray = (_playerArray3 = {}, _defineProperty(_playerArray3, player1, []), _defineProperty(_playerArray3, player2, []), _playerArray3);
	  gameOver = false;
	  $('.square').text('');
	  return false;
	};
...
/***/ function(module, exports, __webpack_require__) {
	...
	module.exports = __webpack_require__.p + "0c801fe9f5b871f334c3654ac2bc5779.jpg";
